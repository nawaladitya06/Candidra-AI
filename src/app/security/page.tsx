...
export const metadata: Metadata = {
  title: "Enterprise-Grade Security — Candidra AI",
  description: "Learn about Candidra AI's security measures, including AES-256 data encryption, Cloudflare security perimeters, isolated LLM inference, and VPN access controls.",
  keywords: ["Candidra security", "enterprise data protection", "AI encryption standard"],
};
