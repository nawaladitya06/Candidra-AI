           ...
           <div className="flex flex-col md:flex-row gap-16 max-w-6xl mx-auto">
              ...
              <div className="flex-1 pt-8">
                 <motion.h1 
                   ...
                   className="text-5xl md:text-7xl font-black text-white tracking-tighter mb-8 leading-[0.9] brutal-heading uppercase text-left"
                 >
                   Let's start a <br />
                 ...
                 <motion.p 
                   ...
                   className="text-xl text-slate-400 font-bold leading-relaxed max-w-md mb-12 font-mono tracking-tight text-left"
                 >
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                             <label className="text-[10px] font-black uppercase tracking-widest text-primary font-mono block text-left">First Name</label>
                          ...
                          <div className="space-y-2">
                             <label className="text-[10px] font-black uppercase tracking-widest text-primary font-mono block text-left">Last Name</label>
                       ...
                       <div className="space-y-2">
                          <label className="text-[10px] font-black uppercase tracking-widest text-primary font-mono block text-left">Work Email</label>
                       ...
                       <div className="space-y-2">
                          <label className="text-[10px] font-black uppercase tracking-widest text-primary font-mono block text-left">Message</label>
